...
var contextRoot = document.URL.match(/[0-9a-zA-Z.\/\-:]*webapp_v2/i)[0].replace("/webapp_v2","");
...
var progress = {
		show:function(message) {
			...
			var progress = $("<div>").addClass("progress").addClass("v-center").css("height", "20px").css("width", "60%");
		...
		setProgress:function(progress) {
			...
			progressElem.text(Number(progress) + "% " + message);
