...
( function( /*window, */document, undefined ) {
    window.app = {
        ...
        // Toast Message.
        requestToast: function( message ) {
            if ( typeof webInterface != 'undefined' ) {
                webInterface.requestToast( message );
            } else {
                // do nothing
            }
        },
        ...
        // Update App list
        updateAppList: function( data ) {
            if ( typeof webInterface != 'undefined' ) {
                webInterface.updateAppList( data );
            } else {
                // do nothing
            }
        },
        ...
        updateAppInfo: function( data ) {
            if ( typeof webInterface != 'undefined' ) {
                webInterface.updateAppInfo( data );
            } else {
                // do nothing
            }
        },
        ...
        // Request App info
        requestAppInfo: function( appId ) {
            if ( typeof webInterface != 'undefined' ) {
                webInterface.requestAppInfo( appId );
            } else {
                // do nothing
            }
        }
